...
A _Real Estate Digital Services_ company that specialise in Real Estate Photography and Videography is looking to promote their business and showcase their craft online. The company requires a website that will reach new clients and make the service booking a quick and pleasant experience.
...
The primary target audiences are the potential clients who wish to use the site to check available services, see recent work and book an appointment in order to put their property on the market, sell their property faster or increase the property value. 

Furthermore, the business owners would like to use the site to showcase their skills and experience by providing examples of their best work. They would like as well display all available services and demonstrate their availability for work.

Based on the above brief the following user stories were identified:
...
- As a user _K_, I want to allow potential clients to quickly and easy book a service online so that I can get more business that way.
- As a user _L_, I want to invite visitors to my social accounts so that I can increase my online presence and reach new potential clients.

### Structure and Skeleton

Due to the business requirements and services characteristics, the site design should be minimal and aesthetic as too much clutter would distract the user from the website's main purpose. The website's simplicity and its responsive structure will provide functionality and intuitive interactions for the users.

The following wireframes were created in order to provide a starting point for the website skeleton:

- <a href="Wireframes/small_device.jpg" target="_blank">Small device</a>
- <a href="Wireframes/medium_device.jpg" target="_blank">Medium device</a>
- <a href="Wireframes/large_device.jpg" target="_blank">Large device</a>
...
There are three main elements on the website that are common for all of the five pages, i.e. _header (navigation)_, _main content_ and _footer_.

### Header (navigation)

The header (navigation) consists of business logotype and navigation bar that changes its appearance from collapsing vertical menu on small devices to horizontal on larger ones. The navigation bar is fixed to the top of the page to make it accessible at all times and help visitors navigate on the site. The logotype element has a link to the home page allowing users to go back when needed. The navigation bar menu elements that consists of _home_, _services_, _online booking_, _about_ and _contact_ page, have links to the their particular pages and all change their appearance on the mouse hover allowing user to quick and easy navigate through them. The currently visited page is clearly marked by a underline element.
...
The main website features are as follows:
...
The features that were not yet possible to implement due to static website requirements are as follows:
...
- [Sublime](https://www.sublimetext.com/) - Text editor used to write down all the code.
- [Python's HTTP server](https://docs.python.org/2/library/simplehttpserver.html) - Simple Python's web server used for testing of the website during the build stage.
...
All of the media files used in the website were made by myself with a exception of the following photographs which were obtained from [Unsplash](https://unsplash.com/):

- "about.jpg" by _ShareGrid_
- "contact.jpg" by _Artem Bali_
- "houses.jpg" by _Daniel Abadia_
- "online-booking.jpg" by _rawpixel_
